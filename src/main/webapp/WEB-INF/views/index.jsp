...
<head>
    ...
    <script type="text/javascript" src="js/a_cartslist_pre.js"></script><%--购物车--%>
...
<div class="top">
    ...
    <div class="search">
        <form>
            <input id="in_search" type="text" value="" class="s_ipt" />
            <input id="start_search" type="submit" value="搜索" class="s_btn" />
        </form>
...
<%--<div class="top">--%>
    ...
    <%--<div class="i_car">--%>
        <%--<div class="car_t">购物车 [--%>
            <%--<c:if test="${sessionScope.user != null}">--%>
                <%--<span>${sessionScope.cartitemamount}</span>--%>
            <%--</c:if>--%>
            <%--<c:if test="${sessionScope.user == null}">--%>
                <%--<<span>0</span>--%>
            <%--</c:if>--%>
